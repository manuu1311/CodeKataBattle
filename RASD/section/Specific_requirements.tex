...
{User, Push Notification Service} % actor
{User registered to the platform as student} % entry condition
{ % event flow
    \begin{enumerate}
...
{User, Push Notification Service} % actor
{User registered to the platform as student, User subscribed to a tournament} % entry condition
{ % event flow
    \begin{enumerate}
